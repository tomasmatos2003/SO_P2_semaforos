...
static void informChef ()
{
    ...
    // printf("\n             O Waiter vai informar o Chef(1)\n\n");
...
static void takeFoodToTable ()
{
    ...
    // printf("\n             O Waiter vai levar a comida para a mesa(2)\n             Os clientes vão começar a comer(5)\n             Os clientes que acabarem mais cedo progressivamente vão esperando pelos outros(6)\n\n");
...
static void receivePayment ()
{
    ...
    /* insert your code here */
    // printf("\n             O Waite vai receber o pagamento(3)\n\n");
